...
summary: End-to-end GenAI and predictive modeling systems built as a Machine Learning Engineer Intern at Ericsson's Global AI Accelerator — RAG-based enterprise search, intent-based network automation, and a centralized AI benchmarking platform.
