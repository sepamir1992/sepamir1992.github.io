...
- A **QoS-slack-driven runtime weight rule** connecting offline utility-based training to online per-chunk path scoring as a Lagrangian relaxation of a constrained QoS optimization, where runtime weights are interpretable as estimated KKT multipliers of the QoS constraints.
